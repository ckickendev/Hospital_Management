			...
			<div id="content">
				...
				<div>
					<form action="patient" method="post">
						<h2 class="text-danger text-center">Thêm vào bệnh nhân</h2>
						...
						<div class="form-group">
							<label for="" style="font-size: 18px">Giới tính</label> <input
								required name="gender" type="text" class="form-control">
						</div>
						...
						<div class="form-group">
							<label for="" style="font-size: 18px">Số điện thoại</label> <input
								required name="phone" type="text" class="form-control">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="" style="font-size: 18px">Mã số bảo hiểm (nếu
								có)</label> <input name="idcard" type="text" class="form-control">
						</div>
