	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			<div id="content">
				...
				<div>
					<form action="dismedication" method="post">
						<h2 class="text-danger text-center">Thêm vào đơn thuốc</h2>
						<div class="form-group">
							<label for="" style="font-size: 18px">Tên bệnh nhân</label> <select class="form-select"
								name="patient_id">
						...
						<div class="form-group">
							<label for="" style="font-size: 18px">Tên thuốc thêm</label> <select class="form-select"
								name="medical_id">
								<php:forEach items="${medications }" var="me">
