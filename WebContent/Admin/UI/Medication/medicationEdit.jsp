					...
					<form action="edit" method="post">
						...
						<div class="form-group">
							<label for="" style="font-size: 18px">Tên thuốc</label> <input
								name="name" type="text" value="${medication.getName() }"
								class="form-control">
						</div>
						<div class="form-group">
							<label for="" style="font-size: 18px">Liều lượng</label> <input
								name="dosage" type="text" value="${medication.getDosage() }"
								class="form-control">
						</div>
						<div class="form-group">
							<label for="" style="font-size: 18px">Ghi chú</label> <input
								name="notes" type="text" value="${medication.getNotes() }"
								class="form-control">
						</div>
						<div class="form-group">
							<label for="" style="font-size: 18px">Giá</label> <input
								name="price" type="text" value="${medication.getPrice() }"
								class="form-control">
						</div>
