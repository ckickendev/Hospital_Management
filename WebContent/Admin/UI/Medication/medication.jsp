		...
		<php:forEach items="${medications }" var="medi">
			<tr>
				...
				<td><a class="btn btn-danger"
					...
					class="btn btn-warning" href="./medication/delete?id=${medi.getId() }">Delete</a>
				</td>
			</tr>
		</php:forEach>
	</table>
	<form action="medication" method="post">
		<h2 class="text-danger text-center">Thêm thuốc</h2>
		...
		<div class="form-group">
			<label for="" style="font-size: 18px">Liều lượng</label> <input
				name="dosage" type="text" class="form-control">
		</div>
		<div class="form-group">
